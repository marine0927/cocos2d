#ifndef _BACKGROUNDINGAMELAYER3_H_
#define _BACKGROUNDINGAMELAYER3_H_

#include "store1/store.h"
#include "BackGround.h"
#include "cocos2d.h"

bool BackGroundInGame3::init()
{
	if (!Layer::init())
	{
		return false;
...
void BackGroundInGame3::update(float dt)
{

}

void BackGroundInGame3::onEnter()
{
	Layer::onEnter();
