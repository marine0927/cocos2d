#ifndef _TABINGAME1LAYER_H_
#define _TABINGAME1LAYER_H_

#include "store1/store.h"
#include "Tab.h"
#include "cocos2d.h"
USING_NS_CC;
bool TabinGame1::init()
{
	if (!Layer::init())
	{
		return false;
...
void TabinGame1::update(float dt)
{
	if (show)
		TabinGame1::setScale(1.0);
	else 
		TabinGame1::setScale(0.0);
...
void TabinGame1::onEnterTransitionDidFinish()
{
	Layer::onEnterTransitionDidFinish();

	auto keyboardListener = EventListenerKeyboard::create();
	keyboardListener->onKeyPressed = CC_CALLBACK_2(TabinGame1::keyPressed, this);
	...
	touchlistener->onTouchBegan = CC_CALLBACK_2(TabinGame1::touchbegin, this);
	touchlistener->onTouchEnded = CC_CALLBACK_2(TabinGame1::touchend, this);
...
void TabinGame1::onExitTransitionDidStart()
{
	Layer::onExitTransitionDidStart();
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
}
void TabinGame1::keyPressed(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event * event)
{
	index++;
	switch (keyCode)
	{
...
bool TabinGame1::touchbegin(Touch* touch, Event *event)
{
...
void TabinGame1::touchend(Touch* touch, Event *event)
{
	text->setScale(0.0);
}
#endif