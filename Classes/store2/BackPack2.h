...
class BackPack2 : public cocos2d::Layer
{
	...
	Vec2 pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9, pos10, pos11, pos12, pos13, pos14, pos15, pos16, pos17, pos18, pos19, pos20, pos21;//原技能所在位置
...
public:
	...
	void addskill2(cocos2d::Sprite * sprite);//修改map
	void back2(Vec2 pos, cocos2d::Sprite * sprite);//技能返回原位
