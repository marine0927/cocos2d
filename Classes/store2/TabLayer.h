#ifndef _TABINGAME2LAYER_H_
#define _TABINGAME2LAYER_H_

#include "store1/store.h"
#include "Tab.h"
#include "cocos2d.h"
USING_NS_CC;
bool TabinGame2::init()
{
	if (!Layer::init())
	{
		return false;
...
void TabinGame2::update(float dt)
{
	if (show)
		TabinGame2::setScale(1.0);
	else 
		TabinGame2::setScale(0.0);
...
void TabinGame2::onEnterTransitionDidFinish()
{
	Layer::onEnterTransitionDidFinish();

	auto keyboardListener = EventListenerKeyboard::create();
	keyboardListener->onKeyPressed = CC_CALLBACK_2(TabinGame2::keyPressed, this);
	...
	touchlistener->onTouchBegan = CC_CALLBACK_2(TabinGame2::touchbegin, this);
	touchlistener->onTouchEnded = CC_CALLBACK_2(TabinGame2::touchend, this);
...
void TabinGame2::onExitTransitionDidStart()
{
	Layer::onExitTransitionDidStart();
	Director::getInstance()->getEventDispatcher()->removeAllEventListeners();
}
void TabinGame2::keyPressed(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event * event)
{
	index++;
	switch (keyCode)
	{
...
bool TabinGame2::touchbegin(Touch* touch, Event *event)
{
...
void TabinGame2::touchend(Touch* touch, Event *event)
{
	text->setScale(0.0);
}
#endif